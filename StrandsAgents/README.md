...
- data/
  - people_graph.txt: Editable people influence graph with preferred contact and expertise
...
Copy `config/env.example` and set the variables accordingly when running the Python service (e.g., export in your shell).
